...
export default function MainComponent() {
  ...
  function isFOFDiscovered(): number {
    if (stats.pagesVisited.findIndex((value) => value === "404") === -1)
      return 0;
    else return 100;
  }
      ...
      <div>
        <Achivement
          ...
          data={{
            ...
            Unlocked: isCompleted(
              percentageCalculation(stats.closedWindows, 1)
            ),
          }}
        />
        <Achivement
          ...
          data={{
            ...
            Unlocked: isCompleted(
              percentageCalculation(stats.closedWindows, 20)
            ),
          }}
        />
        <Achivement
          ...
          data={{
            ...
            Unlocked: isCompleted(
              percentageCalculation(stats.closedWindows, 100)
            ),
          }}
        />
        <Achivement
        ...
        <Achivement
          ...
          data={{
            ...
            Img: "EXPLORER1XL.png",
            Unlocked: isCompleted(
              percentageCalculation(stats.sectionSwitches, 1)
            ),
          }}
        />
        <Achivement
          ...
          data={{
            ...
            Unlocked: isCompleted(
              percentageCalculation(stats.sectionSwitches, 20)
            ),
          }}
        />
        <Achivement
          ...
          data={{
            ...
            Unlocked: isCompleted(
              percentageCalculation(stats.sectionSwitches, 100)
            ),
          }}
        />
        <Achivement
          ...
          data={{
            ...
            Unlocked: isCompleted(
              percentageCalculation(stats.pagesVisited.length, allPages.length)
            ),
          }}
        />
        <Achivement
        ...
        <Achivement
          ...
          data={{
            ...
            Img: "HELP100XL.png",
            Unlocked: isCompleted(
              percentageCalculation(stats.infoClicked, 100)
            ),
          }}
        />
        <Achivement
    ...
    <div className="p-2 bg-neutral-800 rounded-md mb-3">
      <div className="flex">
        <Image
          ...
          className={
            data.Unlocked
              ? "w-24 h-24 rounded-md mr-2"
              : "w-24 h-24 rounded-md mr-2 grayscale opacity-40"
          }
        />
        <div>
          ...
          <div
            className={
              data.Unlocked
                ...
                : "h-2.5 rounded-full bg-secondary-500"
            }
            style={{ width: `${val}%` }}
          ></div>
        </div>
