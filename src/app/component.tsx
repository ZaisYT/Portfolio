...
export default function MainComponent() {
  ...
  return (
    <div className='p-4 min-h-screen xl:flex xl:items-center xl:px-20 bg-background'>
      <div className='grid xl:grid-cols-3'>
        <div className='flex flex-col items-center'>
          ...
          <h2 className='font-Lilita_One text-6xl xl:text-7xl text-background text-center bg-accent rounded-md p-0.5 w-full max-w-52'>BETA</h2>
        </div>
        ...
        <div className='flex flex-col mt-6 justify-center min-w-[90%] xl:min-w-[60%] mx-auto xl:row-start-2 xl:col-span-3'>
          <Link onClick={() => { handleswitch("about") }} href="/about" className='no-underline flex items-center justify-center font-Afacad_Flux rounded-lg text-black min-h-12 text-2xl bg-primary cursor-pointer active:bg-secondary mb-4'>Ir a mi bio en mas detalle</Link>
          <Link onClick={() => { handleswitch("proyects") }} href="/proyects" className='no-underline flex items-center justify-center font-Afacad_Flux rounded-lg text-black min-h-12 text-2xl bg-primary cursor-pointer active:bg-secondary mb-4'>Ir a mis proyectos :P</Link>
          <Link onClick={() => { handleswitch("achivements") }} href="/achivements" className='no-underline flex items-center justify-center font-Afacad_Flux rounded-lg text-black min-h-12 text-2xl bg-primary cursor-pointer active:bg-secondary mb-4'>Logros :33</Link>
        </div>
      </div>
    </div>
  )
