...
export const About = () => {
  return (
    <div id="top" className="p-4 min-h-screen">
      <Header></Header>
        ...
        <div className="xl:grid xl:grid-cols-2">
          ...
          <div className=" row-start-2">
            ...
            <div className="flex flex-col justify-center items-center md:grid md:grid-cols-3 xl:gap-x-2">
              <img draggable={false} className="xl:w-full md:mx-auto w-[70%] max-w-60" src="https://external-media.spacehey.net/media/s0vjjJAJgXVXnIw32Xws9odBt_zpqjKVO1u-i5RDuHzY=/https://shishka.neocities.org/shishka/img/blinkies/46.gif" alt="" />
              <img draggable={false} className="xl:w-full md:mx-auto w-[70%] max-w-60 my-4" src="" alt="" />
              <img draggable={false} className="xl:w-full md:mx-auto w-[70%] max-w-60" src="https://koinuko.pink/mygraphics/blinkies/minecraft.gif" alt="" />
            </div>
          </div>
